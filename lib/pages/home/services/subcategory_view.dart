...
class SubCategoryViewDetaisScreen extends StatefulWidget {
  final dynamic service;
  final String matchingId;

  const SubCategoryViewDetaisScreen(
      {super.key, this.service, required this.matchingId});

  @override
  State<SubCategoryViewDetaisScreen> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<SubCategoryViewDetaisScreen> {
  ...
  void scrollToItem() {
    ...
    if (widget.matchingId != null && widget.matchingId.toString() != "null") {
      ...
      int index = widget.service.children!.indexWhere(
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        ...
        child: Center(child: Consumer<SubCategoryProvider>(
          ...
          if (subCateprovider.isExpanded) {
            displayContent =
                widget.service.pageDescription.toString(); // Full description
          } else {
            // Limit to two lines
            displayContent = widget.service.pageDescription
                .toString()
                .split('\n')
                .take(2)
                .join('\n');
                ...
                children: [
                  ...
                  Html(
                    ...
                    data: subCateprovider.isExpanded
                        ? widget.service.pageDescription
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: widget.service.children!.length,
                              ...
                              children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            softWrap: true,
                                            widget.service.children![index].name
                                                .toString(),
                                            style: TextStyle(
                                                fontFamily:
                                                    GoogleFonts.poppins()
                                              ...
                                              children: [
                                                RichText(
                                                  text: TextSpan(children: [
                                                    TextSpan(
                                                      text:
                                                          '₹ ${widget.service.children![index].price.toString()}  ',
                                                      style: const TextStyle(
                                                          color: Colors.red,
                                                          decoration:
                                                              TextDecoration
                                                  ...
                                                  child: Padding(
                                                    padding:
                                                        const EdgeInsets.only(
                                                            ...
                                                            right: 10),
                                                    child: Text(
                                                      '${widget.service.children![index].discountPercent.toString()}%off',
                                                      style: const TextStyle(
                                                        color: Colors.black,
                                                        fontSize: 14,
                                                        fontWeight:
                                          ...
                                          Text(
                                            '₹${(widget.service.children![index].price! * (1 - widget.service.children![index].discountPercent! / 100)).toStringAsFixed(2)}', // Discounted price
                                            style: const TextStyle(
                                              color: Colors.black,
                                              fontSize: 18,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      children: [
                                        Image(
                                          image: NetworkImage(widget
                                              .service.children![index].imageUrl
                                              .toString()),
                                          height: 150,
                                          width: 80,
                                        ),
                                          ...
                                          child: Consumer<CartProvider>(builder:
                                            ...
                                            return existingItem.quantity == 0
                                                ? Padding(
                                                    ...
                                                    child: GestureDetector(
                                                        onTap: () {
                                                          cartProvider.token!.isNotEmpty && cartProvider.token!=null?
                                                          context
                                                              .read<
                                                                  CartProvider>()
                                                              .addItemm(
                                                          ...
                                                          //  int indexx=context.read<CartProvider>().shoppingCarts.indexWhere((item) => item.productId.id == service.children![index].id);
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              GestureDetector(
                                                                onTap: () {
                                                                  print(
                                                                      "productId:${existingItem.id.toString()} Id:${widget.service.children![index].productId.toString()}  index:$index");
                                ...
                                RichText(
                                  text: TextSpan(children: [
                                    ...
                                    TextSpan(
                                      text:
                                          ' ${widget.service.children![index].description.toString()} ',
                                      style: const TextStyle(
