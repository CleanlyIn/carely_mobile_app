...
import 'package:cleanly/models/pest_control_model/pest_control.dart';
...
import 'package:cleanly/providers/home/service/search__navigate.dart';
...
class PestControlListView extends StatelessWidget {
  final List<PestControl> pestControl = [
    PestControl(
      id: 1,
      image: 'assets/images/01 1.png',
    ...
    PestControl(
      id: 3,
      image: 'assets/images/03 1.png',
      title: 'Flat',
    ),
    PestControl(
      id: 4,
      image: 'assets/images/04 1.png',
      title: 'Farm house',
    ),
  ];

  PestControlListView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return  ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
               print(">>>>>>>>>>>>>${servicesProvider.services[index].name.toString()}");
          return 
          servicesProvider.services[index].name.toString() == "Other Cleanly"?
   
       ListView.builder(
        shrinkWrap: true,
        scrollDirection: Axis.horizontal,
        itemCount: servicesProvider.services[index].children!.length,
        itemBuilder: (BuildContext context, int index1) {
         
                        
          return  servicesProvider.services[index].children![index1].name.toString() == "Pest Control"? 
          ListView.builder(
        shrinkWrap: true,
        scrollDirection: Axis.horizontal,
        itemCount: servicesProvider.services[index].children![index1].subChildren!.length,
        itemBuilder: (BuildContext context, int index2) {
   
                   final serviceList1=servicesProvider.services[index].children![index1].subChildren![index2];
                         print(">>>serviceList>>>>>>>>>>$serviceList1");      
          return 
          Container(
                ...
                children: [
                  Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  '${serviceList1.discountPercent.toString()}%off',
                                  style: const TextStyle(
                                    color: Colors.black,
                                    fontSize: 14,
                      ...
                      Text(
                        ' ₹${((serviceList1.price ?? 0).toInt() * (1 - (serviceList1.discountPercent ?? 0) / 100)).toStringAsFixed(2)}', // Discounted price
                        style: const TextStyle(
                          color: Colors.black,
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                  ...
                  Stack(
                    ...
                    children: [
                      Image(
                        image: NetworkImage(serviceList1.imageUrl.toString()),
                        height: 150,
                        width: 80,
                      ),
                      Positioned(
                                  ...
                                  child: GestureDetector(
                                      onTap: () {
                                        ...
                                        context.read<CartProvider>().addItemm(
                                            serviceList1,
                                            serviceList1.productId.toString(),
                                            index);
